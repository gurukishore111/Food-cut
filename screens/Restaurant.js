            ...
            >
                {
                    restaurant?.menu.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                <Text style={{ marginVertical: 10, textAlign: 'center', fontSize:20,fontWeight:"bold" }}>{item.name} - {item.price.toFixed(2)}</Text>
                            ...
                            >
                                ...
                                <Text style={{
                                    fontSize:18, color: COLORS.darygray
                ...
                >
                    ...
                    >
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.padding, fontSize:17 }}>Location</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.padding, fontSize:18 }}>Near You</Text>
                        </View>
                    </View>
